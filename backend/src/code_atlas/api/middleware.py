...
class SecurityHeadersMiddleware(BaseHTTPMiddleware):
    ...
    Adds standard security headers for production deployment:
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            csp_policy: Content-Security-Policy value (default: restrictive policy).
            ...
            enabled: Whether to add security headers (default: True).
        """
        super().__init__(app)
        self.hsts_max_age = hsts_max_age or self.DEFAULT_HSTS_MAX_AGE
        self.csp_policy = csp_policy or self.DEFAULT_CSP
        self.frame_options = frame_options or self.DEFAULT_FRAME_OPTIONS
        self.referrer_policy = referrer_policy or self.DEFAULT_REFERRER_POLICY
